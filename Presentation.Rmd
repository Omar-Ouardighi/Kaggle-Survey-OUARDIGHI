...
```{r data}
Country2022 <- read.csv('data_output/Country2022.csv')
Country_age <- read.csv('data_output/Country_age.csv')
Gender <- read.csv('data_output/Gender.csv')
img_woman <- readJPEG("img/woman2.jpg", native = TRUE)
img_man <- readJPEG("img/man2.jpg", native = TRUE)
Prog_lang <-  read.csv('data_output/Prog_lang.csv')
```
